...
while True: # This while loop allows the player to 
    ...
    if verse[0:len(verse_response)] == verse_response: # If this returns
        ...
        if character != b'\x08':
            ...
            if (verse_response_minus_one == last_letter_index) & (last_letter_index not in last_letter_indices_reached):
            ...
            if (verse_response_minus_one in df_word_index_list[
                'previous_character_index'].to_list()) & (verse_response_minus_one not in first_letter_indices_reached):
                ...
                word = df_word_index_list.query(
                    'previous_character_index == @verse_response_minus_one').iloc[0][
                        'word']
                print(f" Started typing {word}.")
                first_letter_indices_reached.append(verse_response_minus_one)
