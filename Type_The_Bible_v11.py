...
# * Add in a help/disclaimer/credits section
    ...
    while complete_flag == 0:
        ...
        if test_type == 'v1': 
            ...
            while True: # This while loop allows the player to 
                ...
                elif character == b'\x7f': # This is the output of Ctrl + Backspace
                    # on Windows; I haven't yet tested its output on Mac or Linux.
                ...
                if verse[0:len(verse_response)] == verse_response: # If this returns
                    ...
                    if (character != b'\x08') & (character != b'\x7f'):
            ...
            # is set to {typed_word_without_mistakes}.")
                    ...
                    typed_word_without_mistakes = 0 
                    text_color = Fore.RED 
                    if (character != b'\x08') & (character != b'\x7f'): # Backspaces
                        # won't be counted as part of the incorrect character tally so that
