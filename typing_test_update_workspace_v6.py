...
cursor_y_pos += 1 # This line moves the starting point
# of the cursor down by 1, as I found that it would otherwise
# overwrite the lowest pre-existing line of text.
...
# run_typing_test. It starts right after 'elif test_type == 'v2''.
...
# is set to {typed_word_without_mistakes}.")
    ...
    cursor_reposition_command = f'\033[{cursor_y_pos};{0}H'
    ...
    print(f"{clear_text_to_left_command}{cursor_reposition_command}{text_color}{verse_response} \
{left_cursor_shift}{clear_text_to_right_command}", end = '', flush = True)
